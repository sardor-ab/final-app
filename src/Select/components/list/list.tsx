...
import { EMPTY_DATA, EMPTY_SEARCH, LOADING_TEXT } from 'constants/index';
import * as css from './list.module.scss';
...
export class List extends Component<IProps, IState> {
    ...
    render() {
        const { className, style, isLoading, items, list, selectedId, onSelected, innerRef } =
            this.props;
        const { activeIndex } = this.state;
